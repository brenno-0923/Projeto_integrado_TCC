        ...
        <tbody>
            <?php while ($user_data = mysqli_fetch_assoc($result)) { ?>
                <tr>
					...
					<td><?php echo $user_data['servico']; ?></td>
					<td><?php echo $user_data['confirmar']; ?></td>
                  
                    <td>
                        

<a class='btn btn-sm btn-primary' href='remover-cliente.php?id_cliente=<?php echo $user_data['id_cliente']; ?>' title='Remover'>
...
<a class='btn btn-sm btn-primary' href='finalizar-funcionario.php?id_cliente=<?php echo $user_data['id_cliente']; ?>' title='Finalizar' onclick='finalizado()'>
